  ...
  switch (type) {
    case ACTIONS.ADD_DIGIT:
      ...
      case ACTIONS.EVALUATE:
        if(state.operation == null || state.currentOperand==null || state.perviousOperand==null){
          return state
        }
        return{
          ...state,
  ...
  return (
    <div className="calculator-grid">
      <div className='output'>
        <div className='previous-operand'> {formatOperand(perviousOperand)} {operation} </div>
